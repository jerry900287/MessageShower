...
{
    public partial class ExeFForm : Form
    {
        ...
        private void ExeFForm_Load(object sender, EventArgs e)
        {
            ...
            this.countDownProgressTimer.Enabled = true;
            this.countDownProgressBar.Minimum = 0;
            this.countDownProgressBar.Maximum = countDown; 
            this.countDownProgressBar.Step = 1;
            this.countDownProgressTimer.Interval = 1000; 
        ...
        private void countDownProgressTimer_Tick(object sender, EventArgs e)
        {
            TimeSpan timeSpan = new TimeSpan(0, 0, countDown);
            this.countDownLabel.Text = string.Format("It will start after {0}", timeSpan.ToString(@"hh\:mm\:ss"));

            if (this.countDownProgressBar.Value >= countDownProgressBar.Maximum)
            {
                this.countDownLabel.Text = "Now starting...";
                this.countDownProgressTimer.Enabled = false;
            ...
            this.countDownProgressBar.PerformStep();
            countDown--;
        }
